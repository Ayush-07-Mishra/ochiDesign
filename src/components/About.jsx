...
function About() {
  return (
    <div className='w-full p-[6vw] bg-[#CDEA68] rounded-tr-3xl rounded-tl-3xl '>
      ...
      <div className='w-full border-t-[2px] border-[#7f8e41] mt-20 flex py-[1.5vw]'>
      <div className='w-1/2'>
      ...
      <div className='w-1/2 flex justify-between'>
        <div>
            <div className='w-1/2'>
                <p>We create tailored presentations to help you persuade your colleagues, clients, or investors. Whether it’s live or digital, delivered for one or a hundred people</p><br/>
            </div>
            <div className='w-1/2'>
    ...
    <div className='w-full border-t-[2px] border-[#7f8e41] mt-20  py-[1.5vw] flex justify-between'>
        <div>
